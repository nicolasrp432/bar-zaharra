 ...
 *
 * `image` apunta a /img/products/<id>.jpg — cuando existan fotos reales,
 * basta con dejar los archivos en public/img/products/ con ese nombre y
 * sustituirán automáticamente a la escena ilustrada.
 */
...
export interface Product {
  ...
  tagline: string
  ingredients: string[]
  protagonist: { emoji: string; name: string; text: string }
  pairing?: string
  badges: string[]
  meters: Meter[]
  scene: SceneId
...
export const PRODUCTS: Product[] = [
  // ——— PARA COMPARTIR ———
  {
    ...
    meters: [
      { icon: '🧀', label: 'Queso', value: 5 },
      { icon: '🌶️', label: 'Picante', value: 3 },
      { icon: '🤝', label: 'De compartir', value: 5 },
    ],
    scene: 'nachos',
    image: '/img/products/nachos-cargados.jpg',
    hearty: true,
    meat: false,
    share: true,
  },
  ...
  // ——— RACIONES ———
  {
    ...
    meters: [
      { icon: '🔥', label: 'Crujiente', value: 4 },
      { icon: '🌶️', label: 'Picante (bravas)', value: 3 },
      { icon: '🤝', label: 'De compartir', value: 4 },
    ],
    scene: 'patatas',
    image: '/img/products/patatas.jpg',
    hearty: false,
    meat: false,
    kids: true,
    share: true,
  },
  {
    ...
    meters: [
      { icon: '🔥', label: 'Crujiente', value: 5 },
      { icon: '🍗', label: 'Contundencia', value: 3 },
      { icon: '🤝', label: 'De compartir', value: 4 },
    ],
    scene: 'nuggets',
  ...
  // ——— HAMBURGUESAS ———
  {
    ...
    meters: [
      { icon: '⭐', label: 'Popularidad', value: 4 },
      { icon: '🥩', label: 'Contundencia', value: 3 },
      { icon: '🧀', label: 'Queso', value: 4 },
      { icon: '🌶️', label: 'Picante', value: 1 },
    ],
    scene: 'burger-pollo',
    image: '/img/products/burger-pollo.jpg',
    hearty: true,
    meat: true,
    kids: true,
  },
  {
    ...
    meters: [
      { icon: '⭐', label: 'Popularidad', value: 5 },
      { icon: '🥩', label: 'Contundencia', value: 5 },
      { icon: '🧀', label: 'Queso', value: 3 },
      { icon: '🌶️', label: 'Picante', value: 1 },
    ],
    scene: 'burger-casa',
    image: '/img/products/burger-casa.jpg',
    hearty: true,
    meat: true,
  },
  {
    ...
    meters: [
      { icon: '⭐', label: 'Popularidad', value: 4 },
      { icon: '🌊', label: 'Sabor a mar', value: 5 },
      { icon: '🧀', label: 'Queso', value: 3 },
      { icon: '🌶️', label: 'Picante', value: 2 },
    ],
    scene: 'burger-sepia',
    image: '/img/products/burger-sepia.jpg',
    hearty: true,
    meat: false,
  },
  ...
  // ——— BOCATAS ———
  {
    ...
    meters: [
      { icon: '⭐', label: 'Popularidad', value: 3 },
      { icon: '🥩', label: 'Contundencia', value: 3 },
      { icon: '🧀', label: 'Queso', value: 4 },
    ],
    scene: 'bocata',
    image: '/img/products/bocata-pollo.jpg',
    hearty: true,
    meat: true,
    kids: true,
  },
  {
    ...
    meters: [
      { icon: '⭐', label: 'Popularidad', value: 4 },
      { icon: '🥩', label: 'Contundencia', value: 4 },
      { icon: '🧀', label: 'Queso', value: 4 },
    ],
    scene: 'bocata',
    image: '/img/products/bocata-lomo.jpg',
    hearty: true,
    meat: true,
  },
  {
    ...
    meters: [
      { icon: '⭐', label: 'Popularidad', value: 5 },
      { icon: '🥩', label: 'Contundencia', value: 5 },
      { icon: '🧀', label: 'Queso', value: 1 },
    ],
    scene: 'bocata',
    image: '/img/products/bocata-ternera.jpg',
    hearty: true,
    meat: true,
  },
  ...
  // ——— BATIDOS ———
  {
    ...
    meters: [
      { icon: '🧊', label: 'Frescura', value: 5 },
      { icon: '🥭', label: 'Fruta', value: 5 },
      { icon: '🍦', label: 'Cremosidad', value: 3 },
    ],
    scene: 'shake-mango',
    image: '/img/products/batido-mango.jpg',
    hearty: false,
    meat: false,
    kids: true,
  },
  {
    ...
    scene: 'shake-fresa',
    image: '/img/products/batido-fresa.jpg',
    hearty: false,
    meat: false,
    kids: true,
  },
  ...
  // ——— MALTEADAS ———
  {
    ...
    meters: [
      { icon: '🍦', label: 'Cremosidad', value: 5 },
      { icon: '🍬', label: 'Dulzura', value: 4 },
      { icon: '🧊', label: 'Frescura', value: 4 },
    ],
    scene: 'malteada-vainilla',
    image: '/img/products/malteada-vainilla.jpg',
    hearty: false,
    meat: false,
    kids: true,
  },
  {
    ...
    meters: [
      { icon: '🍦', label: 'Cremosidad', value: 5 },
      { icon: '🍬', label: 'Dulzura', value: 4 },
      { icon: '🍓', label: 'Fruta', value: 4 },
    ],
    scene: 'malteada-fresa',
    image: '/img/products/malteada-fresa.jpg',
    hearty: false,
    meat: false,
    kids: true,
  },
  {
    ...
    meters: [
      { icon: '🍦', label: 'Cremosidad', value: 5 },
      { icon: '🍬', label: 'Dulzura', value: 5 },
      { icon: '🍫', label: 'Intensidad', value: 5 },
    ],
    scene: 'malteada-chocolate',
    image: '/img/products/malteada-chocolate.jpg',
    hearty: false,
    meat: false,
    kids: true,
  },
